package uz.com.ecommers.config;
...
import uz.com.ecommers.filter.FilterToken;
import uz.com.ecommers.service.auth.AuthenticationService;
...
public class SecurityConfig {
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:8081/api/v1", "*"));
